...
```json
{
  ...
  "claim": {
    "title": "Prevented outage",
    "statement": "Deploy reduced downtime < 5min/day over 14d",
    "domain": "infra",
    "impact_class": "HIGH"
  },
  "context": {
    ...
    "uncertainty_markers": [
      "unknown supplier delay"
    ]
  },
  "action_plan": {
    "what_was_done": "replaced PSU + added monitoring",
    "what_counts_as_success": "<5min/day downtime",
    "what_counts_as_failure": ">=60min outage"
  },
  "witness_window": {
    "window_open_at": "2026-01-21T00:00:00Z",
    "window_close_at": "2026-02-04T00:00:00Z"
  },
...
{
  "op_id": "op-...",
  "ce_ref": "ce-2026-01-21-0001",
  "observation": {
    "observed_at": "2026-02-04T00:01:00Z",
    "outcome_summary": "Downtime stayed under threshold",
    "metrics": {
      "avg_downtime_min_per_day": "2.1"
    },
    "l4_signals": [
      "cost_spike:small"
    ]
...
```json
{
  ...
  "challenge": {
    ...
    "reason_text": "No independent logs",
    "requested_action": "REQUEST_MORE_OP"
  },
  "bond": {
    "bond_type": "CHALLENGE_BOND",
    "bond_ref": "bond-...",
    "bond_amount": "100",
    "bond_currency": "EUR"
  }
...
```json
{
  ...
  "resolution": {
    ...
    "scope": "Confirmed for 14d window; not confirmed for seasonal load",
    "basis_refs": [
      "op-...",
      "cr-..."
    ],
    "l4_contradiction": false,
    "issued_at": "2026-02-05T12:00:00Z"
  },
  "arbiter_quorum": {
    "quorum_id": "q-...",
    "members": [
  ...
  "consequences": {
    "bond_action": "RELEASE",
    "authority_update": "BOUND",
    "ea_minting": "MINT_PARTIAL"
  }
}
```
