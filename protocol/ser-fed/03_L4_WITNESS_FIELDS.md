...
It does **not** replace SER v1.3.0 and must not modify the SER core spec.
...
- enforces **exploration budget** for cold-start (Jester protocol)
- adds **prediction bonds** (liability for authority)
...
## Non-goals
- individual cognition design (SER core)
- model training and FL mechanics (handled by LA pipelines elsewhere)
...
- **SER-FED_Assumed_Failure_Modes.md**

They motivate the protocol design but do not define execution logic.

## Relationship to EWCEP
EWCEP defines how influence accumulates from experience.
SER-FED defines how authority expires and renews under L4 selection pressure.
...
This directory contains multiple RFC drafts and normative companions.

- **SER-FED_v0.1_RFC_EN.md** Initial federation draft.
...
- **03_L4_WITNESS_FIELDS.md** (normative)  
  Minimal required fields + lifecycle for CE/OP/CR/RN, referenced by v0.2.
